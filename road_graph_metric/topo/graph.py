...
class RoadGraph:
    ...
    def addEdge(self, nid1, lat1, lon1, nid2, lat2, lon2, reverse=False, nodeScore1=0, nodeScore2=0,
                edgeScore=0):  # n1d1->n1d2
    ...
    # BFS (much faster)
    def TOPOWalk(self, nodeid, step=0.00005, r=0.00300, direction=False, newstyle=False, nid1=0, nid2=0, dist1=0,
                 dist2=0, bidirection=False, CheckGPS=None, metaData=None):
                ...
                if (latI, lonI, lat2 - lat1, lon2 - lon1) not in mables:
                    ...
                    if bidirection == True:
                        if nid1 in self.nodeLink[nid2] and nid2 in self.nodeLink[nid1]:
                            mables.append(
                                (latI + 0.00001, lonI + 0.00001, lat2 - lat1, lon2 - lon1))  # Add another mables
                ...
                if old_node_dist + l < r:
                    ...
                    while cur < l:
                        ...
                        if (latI, lonI, lat2 - lat1, lon2 - lon1) not in mables and turnnel_edge is False:
                            ...
                            if bidirection == True:
                                if next_node in self.nodeLink[node_cur] and node_cur in self.nodeLink[
                                    next_node] and turnnel_edge is False:
                                    mables.append((latI + 0.00001, lonI + 0.00001, lat2 - lat1,
                                                   lon2 - lon1))  # Add another mables
                    ...
                    if (node_cur, next_node) in edge_covered.keys():
                        ...
                        edge_covered[
                            (node_cur, next_node)] = cur - step  # max(cur, edge_covered[(node_cur, next_node)])
