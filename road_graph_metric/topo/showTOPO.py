...
def RenderSVG(marbles, holes, matched_marbles, matched_holes, clat, clon, r, filename, OSMMap=None, starts=None):
    ...
    for i in range(len(matched_marbles)):
        ...
        x1, y1 = Coord2Pixels(matched_marbles[i][0], matched_marbles[i][1], min_lat, min_lon, max_lat, max_lon, sizex,
                              sizey)
        x2, y2 = Coord2Pixels(matched_holes[i][0], matched_holes[i][1], min_lat, min_lon, max_lat, max_lon, sizex,
                              sizey)
