...
random_seed = 4016
dataset = 'globalscale'
dataset_dir = '/yourpath/Global-Scale'
preprocess_dir = '/yourpath/globalscale_preprocess'

# image & patch
img_h, img_w = 2048, 2048
patch_h, patch_w = 512, 512
patch_num_h, patch_num_w = 16, 16
patch_num_h_vec, patch_num_w_vec = 8, 8
patch_num_h_training, patch_num_w_training = 16, 16
margin_size = 0
num_patch_infer = 8
max_node_degree = 12
...
VECTOR_TEACHER.max_road_samples = 2048
VECTOR_TEACHER.max_key_samples = 512
VECTOR_TEACHER.road_random_sigma = 2
VECTOR_TEACHER.key_random_sigma = 2

# Segment Inferencer
SEG_INFER = SimpleNamespace()
SEG_INFER.key_conf_thres = 0.242
...
# backbone
backbone = 'sam_vit_b'
sam_ckpt = './sam_ckpts/sam_vit_b_01ec64.pth'

# neck
neck = 'blank_neck'
downsample_strides = [16]

# seg_head
seg_head_feat_ind = 0
seg_head = 'seg_head'
seg_head_in_channels = 256

'''
This is the configuration of the seg2vector block.
'''
# seg encoder
seg_enc_channels = 128

#seg decoder
seg_dec_inter_channels = 128

#point decoder
point_dec_inter_channels = 128

#vector decoder
vector_dec_inter_channels = 128

##############loss########################
road_bce_loss_weight = 1
road_ftl_loss_weight = 1
road_pos_weight = 1
road_ftl_alpha = 0.5
